<template>
  <div class="container-fluid p-0">
    ...
    <!-- Band Section -->
    <div class="container text-center" style="max-width:800px" id="band">
    ...
    <!-- Contact Section -->
    <div class="container" id="contact" style="max-width:800px; padding-top: 80px;">
